...
class QuickBooksMigrator(Document):
	...
	def _migrate(self):
		try:
			...
			# QuickBooks data can have transactions that do not fall in existing fiscal years in AiBizzApp ERP
	...
	def _save_account(self, account):
		...
		# Map Quickbooks Account Types to AiBizzApp ERP root_accunts and and root_type
		try:
			if not frappe.db.exists(
