...
class TestBankTransaction(FrappeTestCase):
	...
	# This test checks if AiBizzApp ERP is able to provide a linked payment for a bank transaction based on the amount of the bank transaction.
	...
	# Check if AiBizzApp ERP can correctly filter a linked payments based on the debit/credit amount
