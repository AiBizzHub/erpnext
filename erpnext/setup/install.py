...
def check_setup_wizard_not_completed():
	if cint(frappe.db.get_single_value("System Settings", "setup_complete") or 0):
		message = """AiBizzApp ERP can only be installed on a fresh site where the setup wizard is not completed.
...
def check_frappe_version():
	...
	click.secho(
		f"You're attempting to install AiBizzApp ERP version {erpnext_version} with Framework version {frappe_version}. "
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "AiBizzApp ERP")
